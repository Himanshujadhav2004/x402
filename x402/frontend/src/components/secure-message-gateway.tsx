...
export const SecureMessageGateway = () => {
  ...
  return (
    <footer className="w-full border-b+ border-border/50 bg-black/80 backdrop-blur-sm">
      <div className="w-full px-4 py-8 sm:py-12">
        <div className="flex items-center justify-center min-h-[250px] w-full">
          <div className="relative w-full bg-transparent border border-border border-dashed shadow-sm p-6 sm:p-10 transition-all rounded-none">
